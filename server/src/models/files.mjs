...
function storeFileInformation(userId, folderName, fileName, fileSize, isFavourite, uuid) {
  const query = 'INSERT INTO files (userId, folderName, fileName, fileSize, isFavourite, uuid) VALUES (?, ?, ?, ?, ?, ?)';
