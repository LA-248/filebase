...
db.serialize(() => {
  ...
  db.run('CREATE TABLE IF NOT EXISTS folders (id INTEGER PRIMARY KEY, userId INTEGER, folderName TEXT, isFavourite TEXT, shared TEXT, deleted TEXT, currentFolder TEXT, uuid VARCHAR, FOREIGN KEY(userId) REFERENCES users(id))');
});
