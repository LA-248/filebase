...
db.serialize(() => {
  ...
  db.run('CREATE TABLE IF NOT EXISTS folders (id INTEGER PRIMARY KEY, userId INTEGER, folderName TEXT, fileName TEXT, fileSize INTEGER, fileData BLOB, FOREIGN KEY(userId) REFERENCES users(id))');
});
